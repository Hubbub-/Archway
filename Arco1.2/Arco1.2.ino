...
#define printDistAddr 22

// Define pins for distance sensor
#define GRNDPIN 21  //Black
#define TRIGPIN 22  //Yellow
#define ECHOPIN 23  //White
#define MAXDIST 400
...
void setup() {
  ...
  printDistance = EEPROM.read(printDistAddr);
  ...
  pinMode(GRNDPIN,OUTPUT);     // Ground for dist sensor
